...
// whether output the search path
// #define OUTPUT_SEARCH_PATH
// whether count the useful rates
// #define COUNT_USEFUL_RATES
...
struct IDSelector {
    ...
    virtual bool is_member(idx_t id, int pos) const {return false;}
    virtual void set_filter(std::string metadata) {}
    virtual void set_filter_batch(std::vector<std::string>& metadata_array) {}
    virtual void set_sleep_ns(int ns) {}
    virtual ~IDSelector() {}
};

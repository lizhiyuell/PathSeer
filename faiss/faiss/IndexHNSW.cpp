...
#pragma omp for reduction(+ : n1, n2, n3, ndis, ndis_first, nhop, nhop_first, nfilter, nfilter_first, nreorder, ngood, ngood_first, useful_rate)
            for (idx_t i = i0; i < i1; i++) {
                ...
                HNSWStats stats = hnsw.search(*dis, k, idxi, simi, vt, i, params);
    ...
    hnsw_stats.combine({n1, n2, n3, ndis, ndis_first, nfilter, nfilter_first, nhop, nhop_first, ngood, ngood_first, nreorder, useful_rate});
}

...
// we modify the HNSWStats to count for more operations
struct HNSWStats {
    size_t n1, n2, n3;
    ...
    HNSWStats(
            ...
            size_t nreorder = 0,
            float useful_rate = 0)
            : n1(n1), n2(n2), n3(n3), ndis(ndis), ndis_first(ndis_first), nfilter(nfilter), nfilter_first(nfilter_first), nhop(nhop), nhop_first(nhop_first), ngood(ngood), ngood_first(ngood_first) , nreorder(nreorder), useful_rate(useful_rate) {}
